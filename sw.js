...
var VERSION = 'neurostudy-v19';
var SHELL = ['./', './index.html', './manifest.webmanifest',
             './css/styles.css',
             './js/engine.js', './js/planner.js', './js/storage.js', './js/meals.js',
             './js/studylog.js', './js/avatar.js', './js/group.js', './js/cloud.js',
             './js/backup.js', './js/league.js', './js/filter.js', './js/notes.js',
             ...
             './avatar-sheet.png', './avatar-sheet-cheongju.png', './avatar-sheet-2026.jpeg', './cheongju-logo.png', './cheongju-crest.jpg',
