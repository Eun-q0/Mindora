...
$jsFiles = @('engine.js', 'planner.js', 'storage.js', 'meals.js', 'studylog.js', 'avatar.js', 'group.js', 'cloud.js', 'backup.js', 'level.js', 'league.js', 'filter.js', 'notes.js', 'neis.js', 'kids.js', 'sound.js', 'report.js', 'pomodoro.js', 'slime.js', 'app.js')
...
$assets = @('manifest.webmanifest', 'sw.js', 'icon.svg', 'icon-maskable.svg',
            ...
            'avatar-sheet.png', 'avatar-sheet-cheongju.png', 'avatar-sheet-2026.jpeg', 'cheongju-logo.png', 'cheongju-crest.jpg', 'og-cover.png',
