 ...
 *
 * 그림은 avatar-sheet-cheongju.png 한 장에 모여 있다 (4열 × 2행, 셀 200px).
 *   0..4  청주여자고등학교 교복을 입은 여학생 캐릭터 5명
 *
...
(function (global) {
  ...
  var CHARS = [
    { id: 'f1', name: '긴 웨이브', sex: 'f', cell: 0 },
    { id: 'f2', name: '올림머리', sex: 'f', cell: 1 },
    { id: 'f3', name: '단발', sex: 'f', cell: 2 },
    { id: 'f4', name: '긴 생머리', sex: 'f', cell: 3 },
